...
const marcas = [{ "brand": "Seat", "models": ["Alhambra", "Altea", "Altea XL", "Arosa", "Cordoba", "Cordoba Vario", "Exeo", "Ibiza", "Ibiza ST", "Exeo ST", "Leon", "Leon ST", "Inca", "Mii", "Toledo"] },
...
if (marca) {
    marca.onchange = (ev) => {
        const modelos = marcas.find((x) => x.brand === ev.target.value).models;
        modelo.value = null;
        modelo.innerHTML = "";
        for (const option of modelos.sort((a, b) => a.localeCompare(b))) {
